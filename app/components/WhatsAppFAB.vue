...
const whatsappNumber = '201117108646'
const message = encodeURIComponent('مرحباً كود فلو! أنا مهتم بخدماتكم الرقمية.')
...
<template>
  ...
  >
    ...
    <span class="font-bold hidden md:block">{{ t('hero.cta') }}</span>
  </a>
</template>
