      ...
      <div class="relative max-w-6xl mx-auto px-10">
        ...
        <div class="overflow-hidden">
          ...
          <div 
            ...
            :style="{ 
              transform: `translateX(${locale === 'ar' ? '' : '-'}${currentIndex * (100 / itemsToShow)}%)`
            }"
          >
            <div 
        ...
        <div class="flex justify-center gap-2 mt-12">
          <button 
            ...
            :class="[currentIndex === i - 1 ? 'bg-primary-600 w-8' : 'bg-slate-300 dark:bg-slate-700 hover:bg-primary-400']"
          ></button>
        </div>
      </div>
    </div>
